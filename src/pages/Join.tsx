...
const Join = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!formData.firstName || !formData.email) {
      toast({
        title: t("join.fillRequired"),
        description: t("join.fillRequiredDesc"),
        variant: "destructive",
      });
      return;
    }
    ...
    emailjs
      ...
      .then(
        (result) => {
          setIsSubmitted(true);
          toast({
            title: t("join.welcomeTitle"),
            description: t("join.welcomeDesc"),
          });
        },
        (error) => {
          toast({
            variant: "destructive",
            title: t("join.welcomeErrorTitle"),
            description: t("join.welcomeErrorTitleDesc"),
          });
        },
      );
  };
            ...
            <div className="space-y-2">
              ...
              >
                ...
                <option value="improve-endurance">
                  {t("join.improveEndurance")}
                </option>
                <option value="general-fitness">
                  {t("join.generalFitness")}
                </option>

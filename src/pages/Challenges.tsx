                ...
                <div className="p-5">
                  <div className="flex flex-wrap items-center gap-3 mb-3">
                    <span className="flex items-center gap-1.5 text-xs text-muted-foreground">
                      ...
                      {l(challenge.duration)}
                    </span>
                    <span className="flex items-center gap-1.5 text-xs font-medium">
                      <Flame className="w-3.5 h-3.5" />
                      {l(challenge.intensity)}
                    </span>
            ...
            <div className="p-6">
              <div className="flex flex-wrap items-center gap-4 mb-4">
                <span className="flex items-center gap-1.5 text-sm text-muted-foreground">
                  ...
                  {l(selectedChallenge.duration)}
                </span>
                <span className="flex items-center gap-1.5 text-sm font-medium">
                  <Flame className="w-4 h-4" />
                  {l(selectedChallenge.intensity)}
                </span>
                <span className="flex items-center gap-1.5 text-sm text-muted-foreground">
                  <Users className="w-4 h-4" />
                  {selectedChallenge.participants}{" "}
                  {t("challenges.participantsLabel")}
                </span>
              </div>
              <h2 className="font-display text-3xl font-semibold mb-3">
                {l(selectedChallenge.title)}
              </h2>
              <p className="text-muted-foreground mb-6">
                {l(selectedChallenge.description)}
              </p>
            </div>
          </div>
        </div>
